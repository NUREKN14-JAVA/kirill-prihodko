...
public class UserTableModel extends AbstractTableModel {
	...
	List<?> users = null;
	String[] COLUMN_NAMES = { Messages.getString("UserTableModel.id"), Messages.getString("UserTableModel.first_name"),
			Messages.getString("UserTableModel.last_name") }; //$NON-NLS-1$ //$NON-NLS-2$
																// //$NON-NLS-3$
